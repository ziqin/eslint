...
module.exports = new LazyLoadingRuleMap(Object.entries({
    ...
    "await-promise": () => require("./await-promise"),
    ...
    "no-boolean-literal-compare": () => require("./no-boolean-literal-compare"),
    ...
    "no-for-in-array": () => require("./no-for-in-array"),
    ...
    "restrict-plus-operands": () => require("./restrict-plus-operands"),
    semi: () => require("./semi"),
    ...
    "strict-comparisons": () => require("./strict-comparisons"),
